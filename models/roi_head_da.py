...
# 继承自 torchvision 的 RoIHeads，用于实现 Domain Adaptive Faster-RCNN
class SeqRoIHeadsDa(RoIHeads):
    def __init__(self, faster_rcnn_predictor, reid_head, *args, **kwargs):
        ...
        self.memory = None  ## 目标 re-identification 的 memory bank
     ## 用于 Source 域的 GT 匹配
    ...
    # boxes update  # DA使用，Domain标签匹配 + Proposal抽样
    ...
    def extract_da(  # 提取领域适应所需的embedding和标签
        self,
        features,
        proposals,
        image_shapes,
